      ...
      <div className="info">
        <div className="user">
          <Link to={ user.id === currentUser.id ? ("/profile") : (`/user/${user.id}`) }>
            <div className="profile-pic"><img src={(user.photoUrl) ? (user.photoUrl) : "https://res.cloudinary.com/dpx0kwaoi/image/upload/v1642084849/44884218_345707102882519_2446069589734326272_n.jpg_samy6y.jpg"} alt="" /></div>
          </Link>
          <Link to={ user.id === currentUser.id ? ("/profile") : (`/user/${user.id}`) }>
