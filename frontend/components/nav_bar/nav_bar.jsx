        ...
        <div className="drop-down">
          <div className="square" />
           ...
           <ul>
            ...
            <li style={{borderTop: '2px'}}><a href="#">Log Out</a>
            </li>
        </ul>
      </>
    ) : (
