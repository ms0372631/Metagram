    ...
    if (this.state.imageUrl != '') {
      ...
      ( 
        <div className="post-create-container">
          ...
          <label for="file-upload" className="post-create-btn">
            ...
            <form id="rightform" className="modal bottom-right" onSubmit={this.handleSubmit} >
              <div className='modal username-container'>
                <div className="modal profile-pic-container">
                  <span class="_2dbep " role="link" tabindex="-1" style={{width:'28px', height: '28px'}}>
                    <img alt="" class="modal profile-pic" crossorigin="anonymous" datazztestid="user-avatar" draggable="false" src=""/>
                  </span>
              </div>
