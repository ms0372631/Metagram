...
class UserShowSub extends React.Component {
  ...
  render() {
    ...
    let photos = [], postsState, videosState, savedState, taggedState;
    ...
    if (this.state.pageState === 'photos') 
      postsState = (
        <a className="icon-container" style={{borderTopColor:"black"}} onClick={() => this.setState({ pageState: 'photos' })}>
    ...
    if (this.state.pageState === 'videos') 
      videosState = (
        <a className="icon-container" style={{borderTopColor:"black"}} onClick={() => this.setState({ pageState: 'videos' })}>
          <span className='content'>
    ...
    if (this.state.pageState === 'saved')
      savedState = (
        <a className="icon-container" style={{borderTopColor:"red"}} onClick={() => this.setState({ pageState: 'saved' })}>
        <span className='content'>
    ...
    if (this.state.pageState === 'tagged')
      taggedState = (
        <a className="icon-container" style={{marginTopColor:"red"}} onClick={() => this.setState({ pageState: 'tagged' })}>
        <span className='content'>
